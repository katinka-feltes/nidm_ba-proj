...
# !!! Main.UserApp is configured as an alias for Main.NIDM and you might encounter it in some tests
using Main.NIDM, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "NIDM tests" begin
  @includetests ARGS
end
